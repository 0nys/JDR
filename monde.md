...
+ Marchand
	...
	+ Particularité : Échange des cartes contre d'autres cartes du même type. Ses items : bras, 
	  devient agressif quand les 4 yeux sont ouverts (= 4 échanges).
	+ Drop : soin 4
	+ HP : 14/19/23/27/30
	+ Actions : 3/3/4/4/5
...
+ Ogre
	...
	+ Particularités : peut lancer son gourdin. sans gourdin, attaque -1
	+ HP : 20/21/22/23/24
	+ Actions : 1
	+ Éléments : faible gel
...
+ **Boss - Dieu de l'âme**
	...
	+ Particularité : seul Gremetith peut lui faire des dégâts. Se téléporte sur Gremetith gratuitement si distance
	  Premier tour : rayon coupe-bras. Ensuite attaque de temps en temps
	+ Drop : Réincarnation
		+ HP : 1
